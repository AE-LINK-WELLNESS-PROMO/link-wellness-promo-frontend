...
function OtpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (otp.some((digit) => digit === "")) {
      setError(STRINGS.VALIDATION_ERROR.OTP_REQUIRED[getLanguage()]);
      return;
    }
    setError("");
    try {
      ...
      setError(err.message || STRINGS.VALIDATION_ERROR.OTP_VERIFICATION_FAILED[getLanguage()]);
    }
  };
